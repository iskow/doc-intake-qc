...
- **4c — the HTML QC report.** As below, plus a **date-fidelity section** proving every copy's timestamps match the source — a client-facing artifact 4b makes possible.
